...
namespace ProjectApp.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Password,UserTypeId,ConfirmPassword,Email,Company,CompanyLogo,Street,PostalCode,City,State,Country,Phone,CellPhone,FaxNumber,Website,About,AccountType_Id")] Account account)
        {
